...
class MinomuncherData {
  ...
  late AttackCancelledData attackCancelled;
  late LinesCancelledData linesCancelled;
  ...
  MinomuncherData.fromJson(MapEntry<String, Map<dynamic, dynamic>> entry){
    ...
    this.attackCancelled = AttackCancelledData(nick, entry.value["cleanAttacksCancelled"], entry.value["cheesyAttacksCancelled"]);
    this.linesCancelled = LinesCancelledData(nick, entry.value["cleanLinesCancelled"], entry.value["cheesyLinesCancelled"]);
    this.surgeAPM = entry.value["surgeAPM"];
    this.surgeAPL = entry.value["surgeAPL"];
    this.surgeDS = entry.value["surgeDS"];
    ...
    this.surgeAllspin = entry.value["surgeAllspin"];
  }
}
