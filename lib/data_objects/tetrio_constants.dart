...
const Map<String, Duration> sprintAverages = {
  ...
  'x+': Duration(seconds: 19, milliseconds: 021),
  'x': Duration(seconds: 23, milliseconds: 647),
  'u': Duration(seconds: 30, milliseconds: 345),
  'ss': Duration(seconds: 38, milliseconds: 723),
  's+': Duration(seconds: 45, milliseconds: 961),
  's': Duration(seconds: 51, milliseconds: 423),
  's-': Duration(seconds: 59, milliseconds: 994),
  'a+': Duration(seconds: 63, milliseconds: 966),
  'a': Duration(seconds: 71, milliseconds: 322),
  'a-': Duration(seconds: 81, milliseconds: 106),
  'b+': Duration(seconds: 89, milliseconds: 086),
  'b': Duration(seconds: 93, milliseconds: 307),
  'b-': Duration(seconds: 104, milliseconds: 438),
  'c+': Duration(seconds: 111, milliseconds: 179),
  'c': Duration(seconds: 119, milliseconds: 396),
  'c-': Duration(seconds: 138, milliseconds: 914),
  'd+': Duration(seconds: 140, milliseconds: 787),
  'd': Duration(seconds: 160, milliseconds: 768),
};
